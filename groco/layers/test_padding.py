...
class TestEquivariantPadding(TestCase):
    ...
    def test_valid_equiv_1d(self):
        ...
        inputs = tf.random.normal(shape=(1, 30, 3))
        output = layer(inputs)
    ...
    def test_valid_equiv_2d(self):
        ...
        inputs = tf.random.normal(shape=(1, 30, 31, 3))
    ...
    def test_valid_equiv_3d(self):
        ...
        inputs = tf.random.normal(shape=(1, 30, 31, 32, 3))
        output = layer(inputs)
    ...
    def test_channels_first(self):
        layer = EquivariantPadding(kernel_size=2, dimensions=2, strides=3, pading='valid_equiv', data_format='channels_first')
        inputs = tf.random.normal(shape=(1, 3, 30, 31))
        outputs = layer(inputs)
