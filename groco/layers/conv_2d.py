...
class GroupConv2DTranspose(Conv2DTranspose):
    ...
    def call(self, inputs):
        ...
        outputs = self._parent_call(inputs, kernel, bias)
    ...
    def _parent_call(self, inputs, kernel, bias):
        backup = self.kernel, self.bias, self.filters
        self.kernel, self.bias, self.filters = kernel, bias, self.filters * self.subgroup.order
    ...
    def compute_output_shape(self, input_shape):
        ...
        return self.group_transforms.multiply_channels(output_shape)
